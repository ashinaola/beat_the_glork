...
def scan_exit(player_room, exit_location, user_decision):
    print("You are in: {}".format(player_room))
    print("Scanning room...")
    time.sleep(1)
...
def move_rooms(glork_room, player_room, item_placement, user_decision, ROOMS):
        ...
        # display main menu and take in user input
            ...
            match user_decision:
                ...
                case 3: # option -> scan exit
                    scan_exit(player_room, user_decision, exit_location)

                case 4: # option -> check current location
                    print('You are in: {}'.format(player_room))

                case 5: # option -> move rooms
                    player_room = move_rooms(glork_room, player_room, item_placement, user_decision, ROOMS)
